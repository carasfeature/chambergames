...
export const GAMES = {
  ...
  bingo: {
    ...
    squares: [
      /*  1 */ "Christina does an emote",
      /*  2 */ "Amber gags",
      /*  3 */ "Chris or Amber say \"nasty\"",
      /*  4 */ "Kiss",
      /*  5 */ "Christina yells \"Amber!\"",
      /*  6 */ "Amber puts on Summer Fridays",
      /*  7 */ "Chris or Amber mention iPad",
      /*  8 */ "Ebby or Alana in chat",
      /*  9 */ "Christina calls someone",
      /* 10 */ "Amber does a dance",
      /* 11 */ "Captain appearance",
      /* 12 */ "Christina or Amber get hurt",
      /* 13 */ "Amber mentions she's hungry",
      /* 14 */ "Christina steals joke/line from chat",
      /* 15 */ "Krispy gets fired",
      /* 16 */ "Christina says \"Let's go!\" & claps",
      /* 17 */ "Amber does a fireball",
      /* 18 */ "Christina says \"I'm gonna bug out\"",
      /* 19 */ "Popper!",
      /* 20 */ "Christina tells mod to time someone out",
      /* 21 */ "Free cross tile",
      /* 22 */ "Christina baby voice to Captain",
      /* 23 */ "Someone says \"Gorgeous\"",
      /* 24 */ "Christina or Amber get hurt"
    ]
  },
